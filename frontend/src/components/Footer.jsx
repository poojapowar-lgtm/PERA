...
const footerLinks = [
...

  {
    ...
    links: [
      ...
      { name: "Atharva University, Mumbai", to: "https://atharvauniversity.org/" },
      { name: "D. Y. Patil Agriculture & Technical University, Talsande", to: "https://dypatiluniversitypune.edu.in" },
      { name: "Dr. D. Y. Patil Dnyan Prasad University, Pune", to: "https://www.dpu.edu.in" },
      { name: "D. Y. Patil International University, Pune", to: "https://www.dypiu.ac.in" },
      { name: "D. Y. Patil University, Pune (Ambi)", to: "https://dypatiluniversitypune.edu.in" },
      { name: "DES Pune University, Pune", to: "https://despu.edu.in/" },
      { name: "Dr. P. A. Inamdar University, Pune", to: "https://drpaiu.edu.in/" },
      { name: "FLAME University, Pune", to: "http://www.flame.edu.in" },
      { name: "G. H. Raisoni Inter.Skill Tech University, Pune", to: "https://ghristu.edu.in/" },
      { name: "Indira University, Pune", to: "https://indirauniversity.edu.in/" },
      { name: "JSPM University, Pune", to: "https://jspmuni.ac.in/" },
      { name: "MGM University, Aurangabad", to: "https://www.mgmu.ac.in" },
      { name: "MIT ADT University, Pune", to: "https://mituniversity.ac.in/" },
      { name: "MIT Vishwaprayag University, Solapur", to: "https://mitpune.ac.in/mit-vishwaprayag-university-solapur/" },
      { name: "MIT World Peace University, Pune", to: "https://mitwpu.edu.in/" },
      { name: "NICMAR University, Pune", to: "https://www.nicmar.ac.in" },
      { name: "Pimpri Chinchwad University (PCU), Pune", to: "https://pcet.org.in/pcet-pcu.php" },
      { name: "Ramdeobaba university, Nagpur", to: "https://rbunagpur.in/" },
      { name: "Sandip University, Nashik", to: "https://www.sandipuniversity.edu.in" },
      { name: "Sanjay Ghodawat University, Kolhapur", to: "https://sanjayghodawatuniversity.co.in/" },
      { name: "Sanjivani University, Kopargaon", to: "https://sanjivanicoe.org.in/" },
      { name: "Somaiya Vidyavihar University, Mumbai", to: "https://www.somaiya.edu/en" },
      { name: "Spicer Adventist University, Pune", to: "https://sau.edu.in" },
      { name: "Sri Balaji University, Pune", to: "https://www.sbup.edu.in/" },
      { name: "SVKM NMIMS Global University, Dhule", to: "https://www.nmims.edu" },
      { name: "Symbiosis Skills & Professional University, Pune", to: "https://sspu.ac.in" },
