...
const ScholarshipAndAwards = () => {
  return (
    <div className="scholarship-awards-page">
      <h2 className='title'>PERA Scholarships / Awards</h2>

      <section className="section">
        <h3 className='subtitle'>PERA Scholarships-2022</h3>
        <img src={scholarshipImg} alt="PERA Scholarships" className="section-image" />

        <h3 className="inner-heading">Selection Procedure for PERA Scholarship:</h3>
        ...
        <h3 className="inner-heading">Documents Required for PERA Scholarship:</h3>
        <ul className='page-list'>
      ...
      <section className="section">
        <h3 className="subtitle">PERA AWARDS-2022</h3>
        <img src={awardImg} alt="PERA Awards" className="section-image" />

        <h3 className="inner-heading">Selection Procedure for PERA Awards:</h3>
        <ul className='page-list'>
        ...
        <h3 className="inner-heading">Documents Required for PERA Award nomination:</h3>
        <ul className='page-list'>
