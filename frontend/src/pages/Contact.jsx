        ...
        <div className="contact-page">
            ...
            <div className="contact-info">
                <div className="info-box">
                    <h3 className='inner-subtitle'>Address</h3>
                ...
                <div className="info-box">
                    <h3 className='inner-subtitle'>Email</h3>
                    <p><a href="mailto:info@peraindia.in">info@peraindia.in</a></p>
                </div>

                <div className="info-box">
                    <h3 className='inner-subtitle'>PERA CET Enquiry No</h3>
                    <p><a href="tel:+919606046968">+91 9606046968</a></p>
                </div>

                <div className="info-box">
                    <h3 className='inner-subtitle'>Contact Working Hours</h3>
